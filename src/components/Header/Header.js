...
const Header = () => {
  const profileImageUrl = useSelector(state=>state.auth?.authUser?.profileImage)
      ...
      >
        ...
        >
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg px-0 py-0">
                ...
                <div>
                  {/* {size.width > 991 &&<Link href="">
                    <a className="px-3 ml-7 font-size-7 notification-block flex-y-center position-relative">
                      ...
                      <span className="font-size-3 count font-weight-semibold text-white bg-secondary circle-24 border border-width-3 border border-white">
                        3
                      </span>
                    </a>
                  </Link>} */}
                ...
                <div>
                  <Dropdown className="show-gr-dropdown py-5">
                    ...
                    >
                      ...
                      {size.width > 991 && <i className="fas fa-chevron-down heading-default-color ml-6"></i>}
                    </Dropdown.Toggle>
                    {size.width > 991 && (
                      <Dropdown.Menu
                      ...
                      >
                        ...
                        <a
                          className=" dropdown-item logout-a py-2 text-red font-size-3 font-weight-semibold line-height-1p2 text-uppercase"
                    ...
                    //       </a>
                    //     </Link>
                    //     <a className=" dropdown-item logout-a py-2 text-red font-size-3 font-weight-semibold line-height-1p2 text-uppercase"
                    //       onClick={handleLogOut}
                    //     >
                    //       Log Out
                    //       </a>
            ...
            {size.width > 991 && gContext.header.button === "account" && (
