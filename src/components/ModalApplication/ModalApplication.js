...
const ModalSignIn = (props) => {
  ...
  const generatePdf = () => {
    ...
    const input = document.querySelector("div#pdf-element :not(div#contact)");
    const pdf = new jsPDF({ unit: "px", format: "A4", userUnit: "px" });
    pdf.html(input, { html2canvas: { scale: 0.54 } }).then(() => {
      pdf.save("test.pdf");
    });
    ...
    >
      <Modal.Body className="p-0" >
        <div className="container position-relative" >
          ...
          <div className="login-modal-main bg-white rounded-8 overflow-hidden" id="pdf-element">
            <div className="row no-gutters">
              ...
              {/* <!-- Middle Content --> */}
              {/* <!-- Right Sidebar Start --> */}
              <div className="col-12 col-xl-3 order-3 order-lg-2 bg-default-2" id="contact">
